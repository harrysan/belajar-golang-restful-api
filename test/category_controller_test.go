...
func setupTestDB() *sql.DB {
	db, err := sql.Open("mysql", "root:123456@tcp(localhost:3306)/belajar_golang_restful_api_test")
...
func TestUpdateCategorySuccess(t *testing.T) {
	...
	requestBody := strings.NewReader(`{"name" : "Gadget In"}`)
	...
	assert.Equal(t, "Gadget In", responseBody["data"].(map[string]interface{})["name"])
}
